         ...
         {/* Right: Open For Section */}
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#763CAC" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <polyline points="19 12 12 19 5 12" />
                  ...
                  <a href="./Product_designer_resume_sneha_v.pdf" download className="px-6 py-3 rounded-full bg-[#763CAC] text-white font-bold shadow-lg hover:bg-white hover:text-[#763CAC] transition flex items-center gap-2 mt-4 self-center">
