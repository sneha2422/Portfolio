  ...
  const animationHandlers = useMemo(() => {
    ...
    const updateCardTransform = (
      ...
      Object.entries(properties).forEach(([property, value]) => {
        (wrap.style as any).setProperty(property, value);
      });
    };
    ...
    >
      <section ref={cardRef} className="pc-card" style={{ position: 'relative', overflow: 'hidden' }}>
        <div className="pc-inside">
          ...
          <div className="pc-content pc-avatar-content" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', borderRadius: 'inherit', overflow: 'hidden', padding: 0, margin: 0 }}>
            <img
              className="avatar"
              src={avatarUrl}
          ...
          <div className="pc-content" style={{ position: 'relative', zIndex: 2 }}>
